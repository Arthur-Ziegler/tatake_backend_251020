...
class TestUserMaterial:
    ...
    def test_user_material_creation(self):
        """测试创建用户材料"""
        ...
        assert material.reward_name == "用户材料"
        assert material.image_url == "https://example.com/material.jpg"
        assert material.quantity == 10

    def test_user_material_zero_quantity(self):
        """测试零数量用户材料"""
        material = UserMaterial(
            reward_id=str(uuid4()),
            reward_name="无材料",
